...
function pacin() {  
    ...
    printf "ERROR: Packages were not found!\n"
fi
}
export -f pacin
#:++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++:#
##
## $ repo-add /home/fademind/MEGA/yay/yay.db.tar.gz /home/fademind/MEGA/yay/*.pkg.tar;sudo pacman -Sy
## 
## $ repo-add /home/fademind/MEGA/yay/yay.db.tar.gz -n -R;sudo pacman -Sy
##
##
function pacmv() {  
    export LANG=en_US
    export YAY_PAC_DIR="/home/fademind/MEGA/yay"
#     if [[ ! -d "$YAY_PAC_DIR" ]] ; then 
#         mkdir -p "$YAY_PAC_DIR"; 
#     fi
    find "$@" -name "*.pkg.tar*" -type f -exec mv -f -v -t "$YAY_PAC_DIR"  {} +
}
export -f pacmv
##
#:++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++:#
...
#         mkdir -p "$YAY_PAC_DIR"; 
#     fi
    find /tmp/yay/ -name "*.pkg.tar*" -type f -exec mv -f -v -t "$YAY_PAC_DIR"  {} +
}
export -f yaymv
#:++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++:#
...
bind -x '"\C-t": clear && echo -e "\033c\c"'; ## CTRL + T = keyboard shoortcut
#:--------------------------------------------------------------------------------------------------------------------------------------------------------:#
