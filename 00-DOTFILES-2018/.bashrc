...
export -f pun
#:++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++:#
function upy() { yaourt -Syua --noconfirm; }
export -f upy
#:--------------------------------------------------------------------------------------------------------------------------------------------------------:#
### ALIASES ################################################################################################################################################
#:--------------------------------------------------------------------------------------------------------------------------------------------------------:#
...
alias gc='git clone'
alias git-commit="git pull;git add --all && git status && git commit -S -am \"updates 20$(date +%y%m%d)\" && git push -u origin master"
alias grep='grep --color=tty -d skip'
alias kdesu5="kdesu dbus-launch"
