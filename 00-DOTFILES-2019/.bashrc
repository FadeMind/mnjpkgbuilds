...
alias pacb="makepkg -sc;mv /dev/shm/makepkg/packages/* /run/media/$USER/STORAGE_EXT4/YAY/"
#:++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++:#
function pacin() { export LANG=en_US && yes|sudo pacman -U *.pkg.tar*; }
export -f pacin
#:++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++:#
...
alias clean-journal="echo 'clean-journal::Cleaning journal...'; find /var/log/journal -name '*.journal' | xargs sudo rm && sudo systemctl daemon-reload;echo 'clean-journal::Done.';du -h /var/log/journal/ "
